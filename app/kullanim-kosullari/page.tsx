...
export default function Page(){return <LegalPage title="Kullanım Koşulları" intro="Bu web sitesini kullanarak aşağıdaki temel koşulları kabul etmiş olursunuz.">
  ...
  <section><h2>Hesaplama araçları</h2><p>Kârlılık laboratuvarındaki sonuçlar kullanıcı girdileri ve genel varsayımlara dayanır; mali, vergisel veya yatırım danışmanlığı değildir. Gerçek maliyetler platform, kategori, sözleşme ve operasyon koşullarına göre değişebilir.</p></section>
  <section><h2>Dış bağlantılar ve değişiklikler</h2><p>Üçüncü taraf hizmetlerin içerik ve güvenliğinden ilgili sağlayıcı sorumludur. Olivon, site içeriğini ve koşulları mevzuat ve hizmet ihtiyaçlarına göre güncelleyebilir.</p></section>
</LegalPage>}
