...
export default function Page(){return <LegalPage title="Gizlilik Politikası" intro="Olivon, ziyaretçilerinin ve müşteri adaylarının kişisel verilerine saygı duyar; verileri yalnızca açık, sınırlı ve meşru amaçlarla işler.">
  ...
  <section><h2>Saklama ve paylaşım</h2><p>Veriler yalnızca amaç için gerekli süre boyunca tutulur. Barındırma, güvenlik, iletişim ve analiz hizmeti sağlayıcılarıyla sınırlı olarak; mevzuata, sözleşmelere ve uygun güvenlik tedbirlerine bağlı biçimde paylaşılabilir.</p></section>
  <section><h2>Haklarınız</h2><p>Verileriniz hakkında bilgi talep etmek, düzeltme veya silme istemek ve ilgili izinleri geri çekmek için bizimle iletişime geçebilirsiniz.</p></section>
</LegalPage>}
