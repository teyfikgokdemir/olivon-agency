...
export default function BlogPage() {
  const schema={"@context":"https://schema.org","@type":"Blog",name:"Olivon Blog",url:`${SITE_URL}/blog`,publisher:{"@id":`${SITE_URL}/#organization`}};
  return <main className="inner-page">
    <StructuredData data={[schema,breadcrumbSchema([{name:"Ana Sayfa",path:"/"},{name:"Blog",path:"/blog"}])]} />
