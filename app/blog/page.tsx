...
export default function BlogPage() {
  return <main className="inner-page">
    ...
    <section className="inner-hero shell"><p className="section-index">OLIVON İÇGÖRÜLER</p><h1>Dijital kararlar için<br /><em>açık ve uygulanabilir</em> notlar.</h1><p>E-ticaret, görünürlük, web deneyimi ve güvenlik üzerine sahada kullanılabilecek rehberler.</p></section>
