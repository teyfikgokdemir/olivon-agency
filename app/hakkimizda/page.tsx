...
export const metadata: Metadata = {
  title: "Hakkımızda | Olivon Dijital Büyüme Stüdyosu",
...
export default function AboutPage() {
  ...
  return <main className="inner-page about-page">
    ...
    <section className="about-principles shell">{principles.map(([title,text],i)=><article key={title}><span>{String(i+1).padStart(2,"0")}</span><h2>{title}</h2><p>{text}</p></article>)}</section>
