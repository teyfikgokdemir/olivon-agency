...
const serviceGroups = [
  ...
  { title:"ikas kurulum & destek", intro:"ikas mağazalarında strateji, görsel, içerik, entegrasyon ve operasyonu tek süreçte ele alırız.", items:["Mağaza kurulumu","Tema & görsel destek","Entegrasyonlar","Check-up"], href:"/hizmetler/e-ticaret" },
