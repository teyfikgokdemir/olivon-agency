...
const localized = {
  en: { kicker:"NEW PROJECT?", title:"Build a stronger digital system.", cta:"Start a project", about:"Independent digital growth studio connecting strategy, commerce, visibility, automation and security.", expertise:"Capabilities", discover:"Discover", work:"Work", blog:"Insights", faq:"FAQ", contact:"Contact", rights:"All rights reserved.", location:"Kayseri · Türkiye", band:["CROSS-BORDER COMMERCE","Shopify, WordPress & WooCommerce","SECURITY","Cloudflare-first security","INTERNATIONAL","Built in Türkiye, working across markets"] },
  de: { kicker:"NEUES PROJEKT?", title:"Ein stärkeres digitales System.", cta:"Projekt besprechen", about:"Unabhängiges Digitalstudio für Strategie, E-Commerce, Sichtbarkeit, Automatisierung und Sicherheit.", expertise:"Leistungen", discover:"Entdecken", work:"Referenzen", blog:"Insights", faq:"FAQ", contact:"Kontakt", rights:"Alle Rechte vorbehalten.", location:"Kayseri · Türkiye", band:["E-COMMERCE","Shopify, WordPress & WooCommerce","SICHERHEIT","Cloudflare-orientierte Sicherheit","DACH & INTERNATIONAL","Aus Türkiye, für internationale Märkte"] },
  fr: { kicker:"NOUVEAU PROJET ?", title:"Un système digital plus fort.", cta:"Parler du projet", about:"Studio indépendant réunissant stratégie, e-commerce, visibilité, automatisation et sécurité.", expertise:"Expertises", discover:"Découvrir", work:"Réalisations", blog:"Articles", faq:"FAQ", contact:"Contact", rights:"Tous droits réservés.", location:"Kayseri · Türkiye", band:["E-COMMERCE","Shopify, WordPress & WooCommerce","SÉCURITÉ","Sécurité centrée sur Cloudflare","INTERNATIONAL","Basé en Türkiye, actif sur plusieurs marchés"] },
} as const;
      ...
      <footer className="mega-footer">
        ...
        <div className="shell footer-grid">
          <div className="footer-brand">
            <div className="footer-brand-lockup"><span className="brand-mark">O</span><strong>OLIVON</strong></div>
            <p>{text.about}</p>
            <div className="footer-partners">
              <img src="/partners/shopify.svg" alt="Shopify" loading="lazy"/>
              <span style={{fontWeight:800,fontSize:"18px",letterSpacing:"-.03em",color:"#f7f2ed",whiteSpace:"nowrap"}}>WordPress</span>
              <span style={{fontWeight:800,fontSize:"18px",letterSpacing:"-.03em",color:"#f7f2ed",whiteSpace:"nowrap"}}>WooCommerce</span>
            </div>
          </div>
          ...
          <div className="footer-column footer-discover"><h3>{text.discover}</h3><a href={localizedPath(locale,"work")}>{text.work}</a><a href={`/${locale}/blog`}>{text.blog}</a><a href={localizedPath(locale,"faq")}>{text.faq}</a><a href={localizedPath(locale,"contact")}>{text.contact}</a></div>
        </div>
