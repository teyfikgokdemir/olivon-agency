...
const whatsappContent = {
  tr: {
    message: "Merhaba Olivon, web, e-ticaret ve dijital büyüme projem için bilgi almak istiyorum.",
    label: "WhatsApp ile iletişime geç",
    scrollLabel: "Sayfanın başına dön",
  },
  en: {
    message: "Hello Olivon, I'd like to discuss a web, e-commerce or digital growth project for my business.",
    label: "Contact Olivon on WhatsApp",
    scrollLabel: "Back to top",
  },
  de: {
    message: "Hallo Olivon, ich möchte mit Ihnen über ein Web-, E-Commerce- oder digitales Wachstumsprojekt für mein Unternehmen sprechen.",
    label: "Olivon über WhatsApp kontaktieren",
    scrollLabel: "Nach oben",
  },
  fr: {
    message: "Bonjour Olivon, je souhaite échanger avec vous au sujet d’un projet web, e-commerce ou de croissance digitale pour mon entreprise.",
    label: "Contacter Olivon sur WhatsApp",
    scrollLabel: "Retour en haut",
  },
} as const;

type WhatsAppLocale = keyof typeof whatsappContent;

function getLocale(pathname: string): WhatsAppLocale {
  const segment = pathname.split("/").filter(Boolean)[0];
  return segment === "en" || segment === "de" || segment === "fr" ? segment : "tr";
}
  ...
  return (
    <>
      <a
        ...
        href={`https://wa.me/905013484838?text=${whatsappMessage}`}
        target="_blank"
        rel="noreferrer"
